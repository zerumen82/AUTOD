import DEP.main as main
from DEP.argv.checkpoints import arg_checkpoints
from DEP.argv.common import arg_debug, arg_help, arg_version
from DEP.argv.run.argument import arg_altered, arg_auto_rescale, arg_auto_resize, arg_auto_resize_crop, arg_color_transfer, arg_compress, arg_image_size, \
