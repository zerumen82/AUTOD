...
class PromptRewriter:
    ...
    def _rewrite_with_llm(self, prompt: str, llm, image_context: str = "") -> Dict:
        ...
        full_prompt = (
            ...
            "IMPORTANT: 'desnuda' ALWAYS means 'make nude' or 'naked', NEVER 'dissimulate' or 'blur'.\n"
            "- 'magnitude': 0.0 to 1.0 (0.1 for subtle, 0.5 for normal, 0.9 for radical changes like nudity or full outfit change).\n"
            "- 'mask_target': Specific object/body part to edit ('clothes', 'face', 'body', 'background', or 'subject'). "
            "If the request is about nudity/clothes, the target is 'body' or 'clothes', NOT 'face'.\n"
            "Example: Request: 'ponle gafas' -> {\"prompt\": \"add glasses\", \"magnitude\": 0.3, \"mask_target\": \"face\"}\n"
            "Example: Request: 'desnuda' -> {\"prompt\": \"make nude\", \"magnitude\": 0.9, \"mask_target\": \"body\"}<|im_end|>\n"
