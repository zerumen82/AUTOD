...
# -*- coding: utf-8 -*-
"""
Test script for FLUX Schnell image editing
"""
...
from ui.tabs.comfy_launcher import is_comfyui_running, start as start_comfy

def main():
    print("=== FLUX Schnell Test ===")
    ...
    # Try a size that's definitely a multiple of 64
    ...
    # Step 4: Load the client with FLUX model
    print("Loading FLUX Schnell model...")
    # The loader adds .gguf automatically if not present
    flux_version = "flux2-klein-4b"  # Loader will add .gguf extension
    ...
    # Step 5: Generate image with FLUX Schnell
    print("Starting image generation...")
    prompt = "a beautiful landscape, detailed, 8k"
    # For Schnell, we use low steps (it will become max(4, num_inference_steps))
    num_inference_steps = 1  # Will become 4 steps
    denoise = 0.75
    ...
    if result is not None:
        ...
        output_path = "flux_schnell_test_output.png"
